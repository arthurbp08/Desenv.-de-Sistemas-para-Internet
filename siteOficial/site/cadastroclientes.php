    ...
    <div class="container">
        ...
        if ($_REQUEST) {
            ...
            if ($msg == '171') {
                ...
                echo '<div style="border:1px solid grey; background-color:grey;">';
        ...
        <form method="post" action="controller/clientesController.php">
            <table>
                <tr>
                    ...
                    <td><input type="text" placeholder="Insira seu nome aqui." name="nome"></td>
                </tr>
                <tr>
                    <td><label>E-mail:</label></td>
                    <td><input type="email" placeholder="Insira seu e-mail aqui." required name="email"></td>
                </tr>
                <tr>
                    <td><label>Data de nascimento:</label></td>
                    <td><input type="date" name="dataNascimento" placeholder="olá"></td>
                </tr>
                <tr>
                    <td><label>Senha:</label></td>
                    <td><input type="text" requerid name="senha" placeholder="Insira a nova senha aqui."></td>
                </tr>
                <tr>
                    <td><label>Repita sua senha aqui:</label></td>
                    <td><input type="text" requerid name="senha2" placeholder="Repita sua senha aqui."></td>
                </tr>
                <tr>
                    <td></td>
                    <td>
